...
ui <- dashboardPage(
  ...
  dashboardSidebar(
    sidebarMenu(
      menuItem("Budget Allocations", tabName = "budget", icon = icon("check-square")),
      
      menuItem("Baselines", icon = icon("check-square"), startExpanded = TRUE,
        menuSubItem("Baseline Summaries", tabName = "account"),
        menuSubItem("Inputs: Gen Ent Baseline", tabName = "users"),
        menuSubItem("Inputs: Sponsorship Baseline", tabName = "browsing") ),
      
       menuItem("Buy", tabName = "goals", icon = icon("check-square"), startExpanded = TRUE,
        menuSubItem("Input: Gen Ent Buy", tabName = "attribution"),
        menuSubItem("Input: Sponsorship", tabName = "dealers") ),
      
      
       menuItem("Post", tabName = "searches", icon = icon("check-square"), startExpanded = TRUE,
        menuSubItem("TBC", tabName = "display"),
       menuSubItem("TBCs", tabName = "lexus") ),
